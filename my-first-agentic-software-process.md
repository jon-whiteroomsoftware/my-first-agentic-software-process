...
- **Subscriptions:** OpenAI $200/month, Anthropic $200/month, [MorphLLM WarpGrep](https://www.morphllm.com/products/warpgrep) $60 plan.
...
- **Input:** Superwhisper for essentially all text, with a post-processing model cleaning the transcript. (The IDEs now have excellent voice dictation built in, but I still pay for Superwhisper because it's worth it to be able to dictate into any text field on macOS.)
